...
- **Agent Backend v1.0.1.1 — Knowledge Ingestion Security & Gate Fix**
- **HEAD**：(see git log — v1.0.1.1 fix(knowledge): harden ingestion boundaries and test gate)
