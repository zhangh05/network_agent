...
- Development head: v2.2.1 tool-chain routing
...
> **v2.2.1 development head**: v2.2 introduced the canonical namespace catalog
> layered over the stable 88 execution ids. v2.2.1 upgrades routing from a
> single category/group to multi-category `tool_chain` planning, so complex
> requests can expose workspace + network + report tools together without
> changing the 88 execution-tool baseline. See
