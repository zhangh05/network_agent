...
- Development head: v2.2.2 intelligent tool planner
...
> **v2.2.2 development head**: v2.2 introduced the canonical namespace catalog
...
It also validates v2.2.2 deterministic planner and validator samples.
