...
- Routes model tool calls only through model-visible `ToolRouter` definitions.
...
Recent documentation/runtime safety verification for this cleanup path: `152 passed`.
