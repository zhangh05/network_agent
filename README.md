...
- Runtime tool registry: **76 registered / 75 model-visible**
...
- Pure chat, capability discovery, and business turns expose the full model-visible tool catalog to the LLM, including Web search, webpage summary, knowledge, artifact, review, and config-translation tools.
...
```bash
./venv/bin/python -m pytest harness/test_rag_context_foundation.py harness/test_rag_context_eval_script.py -q
