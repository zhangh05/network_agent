...
Single source of truth for the artifact capability. Four tools:
  - artifact.list   (LLM-callable; browse artifacts in workspace/session)
  - artifact.read   (LLM-callable; read content + metadata)
  - artifact.diff   (LLM-callable; text/structured diff between two artifacts)
  - artifact.export (LLM-callable; render as txt / md, no real device push)
    ...
    skills=[
        CapabilitySkillSpec(
            ...
            prompt_summary=(
                ...
                "without verifying via artifact.list. Never generate new "
            ...
            postconditions=[
                "If artifact.read is called, surface authoritative=false / "
            ...
            safety_rules=[
                ...
                "artifact.export is a text rendering, not a push.",
            ],
        ),
    ],
    tools=[
