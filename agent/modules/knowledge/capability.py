...
Workspace knowledge store surface:
...
CAPABILITY_KNOWLEDGE = CapabilityManifest(
    ...
    module=CapabilityModuleSpec(
        ...
        operations=[
            ...
            "delete_source",
            "import_file",
            "list_chunks", "search_chunks",
            "read_chunk", "read_parent",
            "reindex_source",
        ],
        description=(
            "Workspace knowledge store + parent/child chunking + "
    ...
    skills=[
        CapabilitySkillSpec(
            ...
            prompt_summary=(
                ...
                "For raw text use knowledge.import.document; for files "
                "(md/txt/html/docx/text-pdf) use knowledge.import.file. "
                "For retrieval, use knowledge.search + knowledge.parent.read for "
            ...
            postconditions=[
                ...
                "After disable: knowledge.search excludes the source.",
    ...
    tools=[
        ...
        CapabilityToolRef(
            ...
            input_schema={
                ...
                "properties": {
                    ...
                    "source_type": {
                        "type": "string",
                        "description": "Filter by source type, e.g. documentation.",
                        "enum": ["book", "manual", "rfc", "project_doc", "attachment", "memory"],
                    },
                    "scope": {
                        "type": "string",
                        "description": "Scope: global, workspace, or session.",
            ...
            description=(
                ...
                "workspace/{ws_id}/{files,inbox}/; absolute paths "
        ...
        CapabilityToolRef(
            ...
            description=(
                ...
                "content; use knowledge.chunk.read or "
