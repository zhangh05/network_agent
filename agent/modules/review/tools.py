...
tool_handler_list = _build_handler(_review_service.list_review_items, "review.item.list")
tool_handler_update = _build_handler(_review_service.update_review_item, "review.item.update")
