...
CAPABILITY_PACKAGES: tuple[CapabilityPackage, ...] = (
    ...
    CapabilityPackage(
        ...
        tool_ids=("workspace.file.list", "workspace.file.read", "network.config.translate", "network.config.parse", "network.interface.extract", "network.route.extract"),
    ...
    CapabilityPackage(
        ...
        tool_ids=("workspace.file.list", "network.pcap.parse", "network.pcap.session", "network.pcap.filter", "network.pcap.align"),
