...
def handle_memory_list():
    ...
    for r in records:
        ...
        # v3.8: Filter out artifact_summary entries — these are artifact
        # cache records auto-generated by the memory write pipeline, not
        # user-facing agent memories. They have no title and low confidence.
        if d.get("memory_type") == "artifact_summary":
            continue
