...
Usage:
    from core.context.fragments import collect_context

    state = collect_context(state)  # replaces context_loader's 5 ad-hoc blocks

Or manually:
    from core.context.fragments.registry import FragmentRegistry
    ...
    from core.context.fragments.registries import ModuleRegistryFragment, SkillRegistryFragment
