"""SPEG Failure Semantics Closure — post-abort behavior is always defined.
...
from speg_engine.failure_semantics import (
    FailurePolicy,
    FailureContext,
    degraded_result,
...
class TestFailureSemanticsContract:
    ...
    def test_must_define_post_abort(self):
        from speg_engine.runtime_contracts import FailureSemanticsContract
