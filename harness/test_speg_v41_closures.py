"""SPEG v4.1 — 3 system closure tests.
...
from speg_engine.models import ToolResult, ExecutionNode
from speg_engine.planner import PlanSchema, SchemaValidationError
