...
in ``speg_engine.planner.enforce_execution_obligation`` and is
...
from speg_engine.planner import (
...
def test_violation_is_exception():
    ...
    # caught by accident.
    assert ExecutionObligationViolation.__module__ == "speg_engine.runtime_contracts"
...
def test_planner_plan_raises_for_empty_task_intent(monkeypatch):
    ...
    raise.
    """
    from speg_engine.planner import Planner
    from speg_engine.models import SPEGConfig, StatelessContext
    import json
