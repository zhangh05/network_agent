"""SSOT Runtime merger should expose nested tool payloads for final synthesis."""

from __future__ import annotations


def test_result_merger_unwraps_nested_output_payload():
    from core.runtime_engine.models import ExecutionDAG, ExecutionNode, StatelessContext, ToolResult
