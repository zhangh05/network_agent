...
No legacy fallback engine. Cross-vendor unmatched lines default to manual_review.
"""
...
class RuleBasedTranslator:
    ...
    Returns TranslationBundle. No legacy fallback engine.
    """
    ...
    def translate_bundle(
        ...
        Unmatched same-vendor lines → passthrough with LEGACY_STRING.
