"""
Budget Controller for SPEG Engine.
...
from .models import ExecutionBudget, ExecutionDAG, ExecutionNode, SPEGConfig
...
class BudgetController:
    ...
    def __init__(self, config: SPEGConfig | None = None):
        cfg = config or SPEGConfig()
