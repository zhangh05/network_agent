"""
Comprehensive tests for SPEG Engine.
...
from speg_engine.dag_validator import DAGValidator
from speg_engine.tool_runtime import ToolRuntime
from speg_engine.execution_engine import ExecutionEngine
from speg_engine.result_merger import ResultMerger
from speg_engine.finalizer import Finalizer
from speg_engine.planner import Planner, PLANNER_SYSTEM_PROMPT
...
class TestToolRuntime:
    ...
    async def test_execute_simple_tool(self, config):
        ...
        from speg_engine.models import StatelessContext
