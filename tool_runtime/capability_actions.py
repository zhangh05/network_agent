...
EXPLICIT_CAPABILITY_ACTIONS: dict[str, CapabilityAction] = {
    ...
    "host.environment.inspect": CapabilityAction(
        ...
        category="host",
        group="shell",
        preferred_tools=("exec.run",
                         "exec.python", "system.diagnostics"),
        fallback_tools=("exec.slash",),
    ...
    "exec.slash": CapabilityAction(
        capability_action="exec.slash", category="host", group="command",
        preferred_tools=("exec.slash",), reason="Direct canonical action."),
    ...
    "web.official_docs.search": CapabilityAction(
        ...
        preferred_tools=("web.search", "web.page.process"),
        fallback_tools=("web.page.process",),
